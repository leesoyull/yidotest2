...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-24 items-start">
            <div className="space-y-32">
              <div>
                <RevealItem>
                  <span className="text-accent font-bold text-xs tracking-[0.3em] uppercase mb-12 block">Company Intro</span>
                </RevealItem>
                <RevealItem delay={100}>
                  <h2 className="font-brush text-primary leading-none flex flex-row items-baseline gap-12 mt-8">
              ...
              <RevealItem delay={200}>
                <div className="space-y-16 text-muted-foreground text-lg leading-relaxed pt-8">
                  <p className="font-bold text-primary text-5xl md:text-6xl tracking-tight">
                    이롭고 바른 길을 <br/> 함께 걷겠습니다
                  </p>
                  <div className="space-y-8 text-lg font-normal max-w-xl">
                    <p>
              ...
              <RevealItem delay={300} className="pt-24">
                <Button asChild size="lg" className="h-24 px-20 rounded-full bg-primary hover:bg-primary/90 shadow-2xl shadow-primary/20 text-3xl font-black transition-all hover:scale-105">
            ...
            <div className="grid sm:grid-cols-2 gap-10 lg:mt-48">
              {[
                ...
                <RevealItem key={i} delay={i * 150} className="p-12 bg-muted/30 rounded-[3rem] border border-muted hover:border-accent/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5">
                  <h4 className="font-bold text-primary text-2xl mb-6">{card.title}</h4>
      ...
      <SectionReveal id="business" className="bg-background py-48 md:py-64">
        <div className="container mx-auto px-6">
      ...
      <SectionReveal id="status" className="bg-white py-48 md:py-64">
        <div className="container mx-auto px-6">
      ...
      {/* Why Yido Section */}
      <SectionReveal id="why" className="bg-background py-64 md:py-80">
        <div className="container mx-auto px-6">
      ...
      {/* CTA Band */}
      <SectionReveal id="contact" className="bg-primary text-white py-48">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-16">
          ...
          <div className="flex flex-col items-center md:items-end gap-10">
            <RevealItem delay={100}>
              <div className="flex items-center gap-6 py-5 px-10 bg-white/5 rounded-full border border-white/10 backdrop-blur-sm">
                <Mail className="text-accent w-8 h-8" />
                <span className="font-bold text-accent text-2xl">yido610@naver.com</span>
              </div>
            </RevealItem>
            <RevealItem delay={200}>
              <Button asChild size="lg" className="bg-white text-primary hover:bg-accent hover:text-white h-20 px-16 rounded-full text-2xl font-black transition-all shadow-2xl">
