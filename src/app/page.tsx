...
export default function Home() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <div className="space-y-8">
                ...
                {/* 핵심 가치 카드: 요청하신 대로 설명문 아래로 재배치 및 간격 조정 */}
                <div className="grid sm:grid-cols-2 gap-4 mt-8">
                  {[
                    ...
                    <RevealItem key={i} delay={i * 100 + 400} className="p-6 bg-muted/30 rounded-[1.5rem] border border-muted hover:border-accent/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
                ...
                <RevealItem delay={900} className="pt-2">
      ...
      <SectionReveal id="business" className="bg-background py-10 md:py-12">
        <div className="container mx-auto px-6">
      ...
      <SectionReveal id="status" className="bg-white py-10 md:py-12">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-8 space-y-2">
            <RevealItem>
      ...
      {/* Why Yido Section */}
      <SectionReveal id="why" className="bg-background py-12 md:py-16">
        <div className="container mx-auto px-6">
      ...
      {/* CTA Band */}
      <SectionReveal id="contact" className="bg-primary text-white py-10">
