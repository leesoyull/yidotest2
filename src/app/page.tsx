...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Quick Access Band */}
      <div className="bg-primary-foreground py-3 border-b border-muted">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-12">
              <div>
                <RevealItem>
                  <span className="text-accent font-bold text-xs tracking-[0.3em] uppercase mb-4 block">Company Intro</span>
                </RevealItem>
                <RevealItem delay={100}>
                  <h2 className="font-brush text-primary leading-none flex flex-row items-baseline gap-8 mt-2">
                    <span className="text-[18rem] md:text-[22rem] font-black tracking-tighter">이도</span>
                    <span className="text-5xl md:text-6xl font-bold opacity-30 tracking-tight">(利道)</span>
                  </h2>
                </RevealItem>
              </div>

              <RevealItem delay={200}>
                <div className="space-y-8 text-muted-foreground text-lg leading-relaxed pt-2">
                  <p className="font-bold text-primary text-4xl md:text-5xl tracking-tight">
                    이롭고 바른 길을 <br/> 함께 걷겠습니다
                  </p>
                  <div className="space-y-6 text-base font-normal max-w-xl">
                    <p>
              ...
              <RevealItem delay={300} className="pt-8">
                <Button asChild size="lg" className="h-16 px-12 rounded-full bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20 text-xl font-black transition-all hover:scale-105">
            ...
            <div className="grid sm:grid-cols-2 gap-6 lg:mt-24">
              {[
                ...
                <RevealItem key={i} delay={i * 150} className="p-10 bg-muted/30 rounded-[2.5rem] border border-muted hover:border-accent/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5">
      ...
      {/* Why Yido Section */}
      <SectionReveal id="why" className="bg-background py-32 md:py-40">
        <div className="container mx-auto px-6">
      ...
      <SectionReveal id="contact" className="bg-primary text-white py-24">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            <RevealItem delay={100}>
              <div className="flex items-center gap-4 py-4 px-8 bg-white/5 rounded-full border border-white/10 backdrop-blur-sm">
                <Mail className="text-accent w-6 h-6" />
                <span className="font-bold text-accent text-xl">yido610@naver.com</span>
              </div>
            </RevealItem>
            <RevealItem delay={200}>
              <Button asChild size="lg" className="bg-white text-primary hover:bg-accent hover:text-white h-16 px-12 rounded-full text-xl font-black transition-all shadow-xl">
